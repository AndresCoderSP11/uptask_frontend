...
export default function NavMenu({name}:NavMenuProps) {
  ...
  const logout=()=>{
    ...
    /* Recordar que el invalidateQueries hace la actualizacion automatica
    por parte del arreglo fijato a detalle mostrado, en ese caso
    cuando matas ello significa que el layout principal que es la parte de vista
    hara un refetch que permita ver si esta o no autenticado */
