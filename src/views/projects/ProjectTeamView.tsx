...
export default function ProjectTeamView() {
    ...
    const { data, isLoading, isError } = useQuery({
        ...
        queryFn: () => getProjectTeam(projectId), //Cuando recibe un parametero se va hacer uso de un getProjectId
    ...
    <>
        ...
        <p className="text-2xl font-light mt-5 text-gray-600">{}</p>
