...
export default function DashboardView() {
  ...
  /* En este caso solamente haremos solo deleteProject 
  pero recuerda es un useMutation y por aqui se encuentra el link */
/* DIFERENCIA MODERADOR, VS TEAM */
/* Verificar el dashboard para que aparezcan sciertas acciones solo a la parte del moderador mas no al cliente. */


  /* En este caso autorizacion de parte del user , del token */
  ...
  /* En este caso la parte de isLoading se tiene allii asi que normal
  luego se puede en el LINK quitar */
  console.log(data);
...
<ul role="list" className="divide-y divide-gray-100 border border-gray-100 mt-10 bg-white shadow-lg">
      ...
      ):(<p className=" text-center py-20">No se encuentran projectos determinados {''}
